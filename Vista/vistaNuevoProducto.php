        ...
        <div class="px-6 pb-4">
            <form method="POST" action="../Controlador/controladorProducto.php?accion=agregar"
                ...
                <label class="flex flex-col w-full gap-1.5">
                    <p class="text-immersive-blue-black dark:text-startup-white text-sm font-medium">Nombre del producto</p>
                    <input
                        type="text"
                        name="nombreP"
                        placeholder="Ej: Arroz integral"
                        required
                        class="form-input w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-resilient-turquoise/50 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 h-10 placeholder:text-gray-400 dark:placeholder:text-gray-500 px-3 text-sm"
                    />
                </label>

                <!-- Descripción -->
                <label class="flex flex-col w-full gap-1.5">
                    <p class="text-immersive-blue-black dark:text-startup-white text-sm font-medium">Descripción</p>
                    <textarea
                        name="descripcionP"
                        placeholder="Descripción del producto (características, detalles, etc.)"
                        required
                        rows="4"
                        class="form-textarea w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-resilient-turquoise/50 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 placeholder:text-gray-400 dark:placeholder:text-gray-500 px-3 py-2 text-sm resize-none"
                    ></textarea>
                </label>

                <!-- Cantidad Inicial -->
                <label class="flex flex-col w-full gap-1.5">
                    <p class="text-immersive-blue-black dark:text-startup-white text-sm font-medium">Stock inicial</p>
                    <input
                        type="number"
                        name="stock"
                        placeholder="0"
